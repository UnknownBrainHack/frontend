...
import { ImageWrapper, StyledImage, Rating, Description, LikeWrapper } from './styled';
    ...
    <Link href="item" passHref>
      <S.Card className="card-item">
        <LikeWrapper likes={likes}>
          <S.LikeButton onClick={e=>{e.stopPropagation();}} type="button" className="card-item__like-btn">
            <span>{likes}</span>
            <svg
              width="18"
              height="16"
